<?php
/* Template Name: reinitialisation_stagiaires Page */
get_header(); 
    ...
    <div class="contains">
        <div class="container">
            ...
            <div class="signup-form">
                ...
                <hr>
                <?php echo $msg; ?>
                <form action="http://localhost/brnsmart/reinitialisation_personne_morale?token=<?php echo $TokenFromUrl; ?>" method="POST" role="form">
