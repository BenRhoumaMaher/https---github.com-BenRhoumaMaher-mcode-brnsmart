...
/* Template Name: table_formation_realisee Page */
...
if(isset($_POST['date'])){
    ...
    $sql = "update formations_realisees set code_formation = '$code_formation',
    date = '$date'
    where id = '$id'";
...
if (isset($_REQUEST["create"])) 
{
    ...
    $query = "INSERT into `formations_realisees` (code_formation,date,create_datetime)
    VALUES (
        '$code_formation','$date',
        '$create_datetime')";
...
<head>
    ...
    <title>Table-Formation-Realisée</title>
            ...
            <div class="col-md-10 col-md-offset-1" >
                <div class="tabling">
                    <table class="table">
                        ...
                        <div>
                            <a href="http://localhost/brnsmart/telecharger_formation_realisee">
                          ...
                          <tbody id="table">
                            ...
                            if ($num>0){
                                while($row=mysqli_fetch_assoc($result)) {
                                    ...
                                    href='
                                    http://localhost/brnsmart/supprimer_formation_realisee?supprimer=
                                    " .$row["id"]. " '>Supprimer</a>
                                    </td>
                                    </tr>"; 
                                }
 ...
 $(document).ready(function(){
     ...
     $('#save').click(function(){
         ...
         $.ajax({
            ...
            method: 'POST',
            data : {code_formation : code_formation, date: date, id : id},
...
<script>
  $(document).ready(function(){
     $('#rechercher').on("keyup", function(){
       ...
       $.ajax({
         method:'POST',
         url:'http://localhost/brnsmart/rechercher_formation_realisee',
