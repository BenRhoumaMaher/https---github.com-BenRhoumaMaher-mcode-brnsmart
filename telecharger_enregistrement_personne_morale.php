...
/* Template Name: telecharger_enregistrement_personne_morale Page */
session_start();
require "db.php";
?>
<?php
	...
	<table class="table table-hover">
		<thead>
			<tr>
				...
				<th style="border: 2px solid black;" class="">Utilisateur</th>
				...
				<th style="border: 2px solid black;" class="">Presentation</th>
