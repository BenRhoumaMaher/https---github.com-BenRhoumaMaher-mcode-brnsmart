<?php
/* Template Name: reinitialisation_formateur Page */
get_header(); 
    ...
    <div class="contains">
        <div class="container">
            ...
            <div class="signup-form">
                ...
                <hr>
                <?php echo $msg; ?>
                <form action="http://localhost/brnsmart/reinitialisation_formateur?token=<?php echo $TokenFromUrl; ?>" method="POST" role="form">
