<?php
/* Template Name: reinitilistion_admin Page */
get_header(); 
...
if(isset($_GET['token'])){
    ...
    )
    {
        ...
        if($result){
         ...
         header(
            "Location: http://vps-64415b44.vps.ovh.net/connexion_administrateur/"
        );
     }else {
    ...
    <div class="contains">
        <div class="container">
            ...
            <div class="signup-form">
                ...
                <hr>
                <?php echo $msg; ?>
                <form action="http://localhost/brnsmart/reset_password_admin?token=<?php echo $TokenFromUrl; ?>" method="POST" role="form">
